  ...
  return (
    <section id="features" className="scroll-mt-28 pt-20 pb-10" aria-labelledby="features-title">
      <Reveal className="mx-auto max-w-3xl px-5 text-center lg:px-8">
        <h2 id="features-title" className="text-3xl font-medium leading-tight text-ink lg:text-4xl">
          {t.featuresIntro.title}
        </h2>
        <p className="mt-4 text-lg text-ink-soft">{t.featuresIntro.subtitle}</p>
      </Reveal>
          ...
          return (
            <Reveal key={f.eyebrow}>
              ...
              <div className={reversed ? "lg:order-2" : ""}>
                ...
                <h3 id={titleId} className="mt-3 text-2xl font-medium text-ink lg:text-3xl">
                  {f.title}
                </h3>
              ...
              <div className={reversed ? "lg:order-1" : ""}>
                <div className="rounded-2xl border border-grey-100 bg-grey-100/40 p-4 shadow-card sm:p-6">
                  <img
                    src={art.url}
                    alt={art.alt}
